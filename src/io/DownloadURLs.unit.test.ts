...
describe("DownloadURLs", () => {
  it("provides expected URLs", () => {
    expect(URL.skiAreasDownloadConfig.url).toMatchInlineSnapshot(
    ...
    expect(URL.runsDownloadConfig.url).toMatchInlineSnapshot(
    ...
    expect(URL.liftsDownloadConfig.url).toMatchInlineSnapshot(
